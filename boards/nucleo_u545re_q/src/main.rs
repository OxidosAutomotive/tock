...
unsafe fn start() -> (
    ...
    let hash_data_buffer = static_init!([u8; 4], [b'a', b'b', b'c', b'd']);

    let hash_digest_buffer = static_init!(
        [u8; 32],
        [
            0x12, 0x3d, 0x4c, 0x7e, 0xf2, 0xd1, 0x60, 0x0a, 0x1b, 0x3a, 0x0f, 0x6a, 0xdd, 0xc6,
            0x0a, 0x10, 0xf0, 0x5a, 0x34, 0x95, 0xc9, 0x40, 0x9f, 0x2e, 0xcb, 0xf4, 0xcc, 0x09,
            0x5d, 0x00, 0x0a, 0x6b
        ]
    );
