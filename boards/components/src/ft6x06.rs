...
macro_rules! ft6x06_component_static {
    ...
    ($I:ty $(,)?) => {{
        ...
        $crate::ft6x06_component_static!($I, RoundRobinPolicy)
    };};
}
...
impl<
        I: 'static + i2c::I2CMaster<'static>,
        SP: 'static + SelectionPolicy<&'static I2CDevice<'static, I, SP>>,
    > Component for Ft6x06Component<I, SP>
{
    type StaticInput = (
        &'static mut MaybeUninit<I2CDevice<'static, I, SP>>,
        &'static mut MaybeUninit<Ft6x06<'static, I2CDevice<'static, I, SP>>>,
        &'static mut MaybeUninit<[u8; 17]>,
        &'static mut MaybeUninit<[kernel::hil::touch::TouchEvent; 2]>,
    );
    type Output = &'static Ft6x06<'static, I2CDevice<'static, I, SP>>;
