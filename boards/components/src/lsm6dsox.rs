...
macro_rules! lsm6ds_i2c_component_static {
    ...
    ($I:ty $(,)?) => {{
        ...
        $crate::lsm6ds_i2c_component_static!($I, RoundRobinPolicy)
    };};
}
...
impl<
        I: 'static + i2c::I2CMaster<'static>,
        SP: 'static + SelectionPolicy<&'static I2CDevice<'static, I, SP>>,
    > Component for Lsm6dsoxtrI2CComponent<I, SP>
{
    type StaticInput = (
        &'static mut MaybeUninit<I2CDevice<'static, I, SP>>,
        &'static mut MaybeUninit<[u8; 8]>,
        &'static mut MaybeUninit<Lsm6dsoxtrI2C<'static, I2CDevice<'static, I, SP>>>,
    );
    type Output = &'static Lsm6dsoxtrI2C<'static, I2CDevice<'static, I, SP>>;
