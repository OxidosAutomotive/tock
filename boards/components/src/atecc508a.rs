...
macro_rules! atecc508a_component_static {
    ...
    ($I:ty $(,)?) => {{
        ...
        $crate::atecc508a_component_static!($I, RoundRobinPolicy)
    };};
}

pub struct Atecc508aComponent<
...
impl<
        I: 'static + i2c::I2CMaster<'static>,
        SPI: 'static + SelectionPolicy<&'static I2CDevice<'static, I, SPI>>,
    > Atecc508aComponent<I, SPI>
{
    pub fn new(
        i2c: &'static MuxI2C<'static, I, NoSMBus, SPI>,
        i2c_address: u8,
        wakeup_device: fn(),
    ) -> Self {
        Atecc508aComponent {
...
impl<
        I: 'static + i2c::I2CMaster<'static>,
        SPI: 'static + SelectionPolicy<&'static I2CDevice<'static, I, SPI>>,
    > Component for Atecc508aComponent<I, SPI>
{
    type StaticInput = (
