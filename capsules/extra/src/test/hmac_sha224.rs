...
pub struct TestHmacSha224<'a, H: digest::Digest<'a, 32>> {
    hmac: &'a H,
...
impl<'a, H: digest::Digest<'a, 32> + HmacSha224<'a>> TestHmacSha224<'a, H> {
    pub fn new(
        hmac: &'a H,
        key: &'static mut [u8],
        data: &'static mut [u8],
...
impl<'a, H: digest::Digest<'a, 32>> digest::ClientData<32> for TestHmacSha224<'a, H> {
...
impl<'a, H: digest::Digest<'a, 32>> digest::ClientHash<32> for TestHmacSha224<'a, H> {
...
impl<'a, H: digest::Digest<'a, 32>> digest::ClientVerify<32> for TestHmacSha224<'a, H> {
    fn verification_done(&self, _result: Result<bool, ErrorCode>, _compare: &'static mut [u8; 32]) {
    }
}

impl<'a, H: digest::Digest<'a, 32>> CapsuleTest for TestHmacSha224<'a, H> {
